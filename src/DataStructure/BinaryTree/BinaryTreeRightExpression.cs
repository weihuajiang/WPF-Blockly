...
{
    public class BinaryTreeRightExpression : Expression, IAssignment
    {
        ...
        public override Descriptor Descriptor
        {
            get
            {
                ...
                desc.Add(new TextItemDescriptor(this, ".right"));
                return desc;
            }
        }
        ...
        public Completion Assign(ExecutionEnvironment enviroment, object value)
        {
            ...
            if ((Node is Identifier))
            {
                ...
                tree.Right = value as BinaryTree;
            ...
            else
            {
                ...
                {
                    (c.ReturnValue as BinaryTree).Right = value as BinaryTree;
                    return new Completion(value);
                }
                else
        ...
        protected override Completion ExecuteImpl(ExecutionEnvironment enviroment)
        {
            ...
            if ((Node is Identifier))
            {
                ...
                return new Completion(tree.Right);
            }
            else
            {
                var c = Node.Execute(enviroment);
                ...
                if (c.ReturnValue is BinaryTree)
                {
                    return new Completion((c.ReturnValue as BinaryTree).Right);
                }
                else
                    return Completion.Exception("value is not binary tree", Node);
            }
