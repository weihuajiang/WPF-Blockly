...
namespace DemoScriptEditor
{
    class Serialization
    {
        private static XmlNode CreateClassNode(Script sp, XmlDocument xmlDoc)
        {
        ...
        public static void Save(Script sp, string file)
        {
        ...
        public static Script Load(string file)
        {
            XmlDocument xmlDoc = new XmlDocument();
            xmlDoc.Load(file);
        ...
        private static Script LoadModule(XmlNode root)
        {
            if (root.Name != "Class")
                return null;
